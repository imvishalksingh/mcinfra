      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 px-8 py-12 max-w-7xl mx-auto font-body-md text-sm leading-relaxed">
        <div className="space-y-6">
          <div className="flex items-center">
            <img src="/logo.png" alt="MC Infra" className="h-14 w-auto object-contain brightness-0 invert" />
          </div>
          ...
          <div className="flex gap-4">
            <a href="https://www.facebook.com/profile.php?id=61570796094359" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-secondary-container transition-colors">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href="https://www.instagram.com/mcinfra/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-secondary-container transition-colors">
            ...
            <a href="https://www.youtube.com/@mcinfrastructure" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-secondary-container transition-colors">
        ...
        <div>
          ...
          <p className="text-gray-400 mb-4">Office no 501, Gokul Vihar, Rohta Road, Near Cambridge Public School Pin 250002.</p>
          <p className="text-gray-400">
            T: +91 79830 32984<br />
            E: Sales@mcinfra.in
          </p>
